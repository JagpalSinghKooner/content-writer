...
This playbook requires quarterly review to stay current. Platform algorithms and best practices change frequently.

### Review Schedule

**Review Cycle:** Quarterly (every 3 months)
**Last Updated:** See YAML frontmatter at top of file
**Next Review:** See YAML frontmatter at top of file

### What to Check When Updating

| Section | What to Verify |
|---------|----------------|
| **Algorithm Signals** | Check for announced algorithm changes; update priority order if signals have shifted |
| **Optimal Specs** | Verify character limits, image dimensions, video lengths; platforms often change these |
| **Year-Specific Notes** | Update "December 2025" references to current date; remove outdated change notes |
| **Hook Formulas** | Test if hook patterns still perform; add new high-performing patterns; remove stale ones |
| **Creator Examples** | Confirm creators are still active and relevant; replace inactive accounts |
| **Platform Features** | Document new post types, algorithm tools, or features that affect content strategy |
| **CTR/Engagement Benchmarks** | Update benchmark ranges based on current industry data |

### Sources for Updates

**Check these sources quarterly:**

1. **Official Platform Blogs**
...
3. **Creator Communities**
   - Follow algorithm researchers on each platform
   - Monitor hashtags like #LinkedInAlgorithm, #TikTokGrowth
   - YouTube Creator Insider channel

### Update Process

1. Search "[platform] algorithm update [current year]" for each platform
2. Review official platform announcements from the past quarter
3. Update specs, signals, and examples as needed
4. Update `last_updated` and `next_review` dates in YAML frontmatter
5. Also update "Last Updated" section in `SKILL.md`

### Version History

| Date | Changes |
|------|---------|
| 2026-02-02 | Initial maintenance section added; established quarterly review cycle |
