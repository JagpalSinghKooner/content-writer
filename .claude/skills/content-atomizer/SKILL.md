...
Save atomized content to the distribution folder within the pillar:

```
{pillar}/distribution/{article-slug}/
├── linkedin.md      # LinkedIn carousel + text posts
├── twitter.md       # Twitter/X thread + single tweets
├── newsletter.md    # Newsletter snippet
└── instagram.md     # Instagram carousel + Reel script
```

**File naming:**
- Use the article slug from the source content
- Each platform file contains all content for that platform
- Include platform-specific formatting and specs in each file

**Example:**
If atomizing `articles/01-what-is-seo.md`, output goes to:
- `distribution/what-is-seo/linkedin.md`
- `distribution/what-is-seo/twitter.md`
- `distribution/what-is-seo/newsletter.md`
- `distribution/what-is-seo/instagram.md`

**Template Reference:** For detailed specifications, see `templates/distribution-template.md`.
...
**Input from:**
- **seo-content** → Blog posts to atomize (from `articles/{nn}-{slug}.md`)
...
3. Output saved to `distribution/{slug}/` folder
4. Each piece drives back to source or offer
5. Repeat with next piece of source content
