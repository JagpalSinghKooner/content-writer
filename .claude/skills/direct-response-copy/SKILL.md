...
For deeper frameworks and extensive examples, see the separate reference files in this folder:

| File | Contents |
|------|----------|
| `frameworks-reference.md` | Classic frameworks from Schwartz, Hopkins, Ogilvy, Halbert, Caples, Sugarman, Collier |
| `headlines-reference.md` | Headline formulas, examples, and testing principles |
| `openings-reference.md` | Opening line patterns and hooks |
| `curiosity-reference.md` | Curiosity gaps and open loop techniques |
| `flow-reference.md` | Slippery slide flow techniques |
| `modern-examples-reference.md` | Modern internet-native copy examples |

**Note:** These reference files are NOT loaded by default to reduce context window usage. Read them when you need specific frameworks or examples for writing new copy.
