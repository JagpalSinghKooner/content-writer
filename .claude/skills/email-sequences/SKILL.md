...
### 1. Lead Magnet Handoff (if available)

If the lead-magnet skill was used, start with the handoff document. It contains:

| Field | What You'll Extract |
|-------|---------------------|
| **Lead magnet name** | For subject lines and delivery email |
| **Format** | Informs delivery instructions |
| **The hook** | Why they opted in — reinforce this in welcome email |
| **The bridge** | Drives bridge email content (Email 5) |
| **Quick win delivered** | Reference in value emails |
| **Paid offer details** | Price point, transformation — informs pitch strategy |

If no handoff exists, gather this information manually (see below).
...
Emails don't need the same E-E-A-T rigour as SEO articles, but citations still build trust—especially when making claims about results or trends.

### When to Cite

| Situation | Citation Needed? | Example |
|-----------|------------------|---------|
| Statistical claims | Yes | "73% of subscribers never read past email 1" |
| Research references | Yes | "Studies show personalised subject lines increase opens" |
| Expert quotes | Yes | Quoting an authority on a topic |
| Personal experience | No | "I tested this and found..." |
| Common knowledge | No | "Email is more personal than social media" |
| Opinion | No | "I think the best approach is..." |

### Format for Emails

Email citations should feel natural, not academic. Use inline attribution:

**Preferred formats:**
- "Research from [Source] shows that..."
- "According to [Source], ..."
- "[Expert name], [credential], found that..."
- "A [Year] study by [Organisation] revealed..."

**With links (when possible):**
> Research from [Litmus](https://litmus.com) shows that 43% of emails are opened on mobile.

**Without links (when URL is too long or distracting):**
> According to a 2024 McKinsey report, personalisation can drive 40% more revenue.

### Minimum Requirements

| Email Type | Citation Requirement |
|------------|---------------------|
| Welcome sequence | None required |
| Nurture emails | None required (focus on value) |
| **Conversion/pitch emails** | **At least 1 citation** when making claims about results or trends |
| Launch emails | At least 1 citation if claiming market shifts or stats |
| Re-engagement | None required |

### What Makes a Good Email Citation

**Do:**
- Use round numbers ("nearly 50%" not "47.3%")
- Name recognisable sources (industry leaders, research firms, publications)
- Keep it brief—one source per claim is enough
- Link when it adds credibility without cluttering

**Don't:**
- Stack multiple citations in one email (academic feel)
- Cite obscure sources no one recognises
- Cite competitors
- Make up statistics (readers can tell)

### Examples

**Good (conversion email):**
> Most lead magnets fail in the first 24 hours. According to Campaign Monitor, the average welcome email open rate is 82%—your highest engagement window. Miss it, and you've lost them.

**Good (launch email):**
> The market is shifting. Gartner reports that 80% of B2B sales interactions will happen in digital channels by 2025. If your email sequences aren't converting, you're leaving money on the table.

**Avoid:**
> Studies show that email marketing has a 4,200% ROI (DMA, 2019) and that personalised emails deliver 6x higher transaction rates (Experian, 2020) while segmented campaigns see 760% increase in revenue (Campaign Monitor, 2021)...

Too many citations. Pick the strongest one and move on.
...
**Template Reference:** For detailed specifications, see `templates/email-sequence-template.md`.
