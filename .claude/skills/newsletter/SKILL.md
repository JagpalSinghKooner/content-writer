...
Newsletters build authority through credible sourcing. Requirements vary by format:

| Format | Citation Requirement | Why |
|--------|---------------------|-----|
| **Deep-Dive / Framework** | 2+ external citations | Establishes expertise, proves you've done the research |
| **News Briefing** | Link to all news sources | Readers need to verify and explore; it's journalism |
| **Curated Links** | Citations by nature | The format IS curation—every link is a source |
| **Personal Essay** | 1+ citation for statistical claims | Opinions are fine uncited; data needs backing |
| **Builder/Startup Update** | 1+ when claiming trends | "The market is shifting" needs evidence |
| **Irreverent News** | Link to primary sources | Humour doesn't excuse unsourced claims |

**Citation Format for Newsletters:**

Keep it scannable. Inline links work best:

> According to [Lenny Rachitsky's research](url), the best newsletters focus on one topic per edition.

> A [recent a]16z report](url) found that AI startups are raising 40% faster than last year.

**For statistics:**
> 73% of newsletter subscribers decide within 3 seconds whether to keep reading ([Litmus, 2024](url)).

**When linking feels heavy:**
> Morning Brew grew to 4 million subscribers—largely through their referral programme.

(Link "referral programme" if it adds value, skip if it interrupts flow.)

**The Rule:** If you're making a claim that isn't common knowledge or personal opinion, link to a source. If the source would strengthen your authority, include it. If it distracts from the point, name-drop without linking.
