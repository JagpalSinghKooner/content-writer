...
## Handoff to Email Sequences

When a lead magnet concept is selected, create a handoff document for the email-sequences skill. This ensures the welcome sequence, value emails, bridge emails, and pitch emails all align with the lead magnet promise.

### Required Handoff Information

| Field | What to Include | Why It Matters |
|-------|-----------------|----------------|
| **Lead magnet name** | The title/name of the lead magnet | Used in subject lines and delivery email |
| **Format** | Quiz, PDF, calculator, challenge, etc. | Affects delivery instructions and follow-up content |
| **The hook** | Why someone downloads (the promise) | Welcome email must reinforce this promise |
| **The bridge** | How it connects to paid offer | Drives bridge emails and pitch positioning |
| **Quick win delivered** | The transformation they get for free | Value emails reference and extend this |
| **Paid offer details** | What you're selling, price point | Determines pitch email strategy and trust-building length |

### Handoff Format

```markdown
## Lead Magnet Handoff for Email Sequences

**Lead Magnet:** [Name]
**Format:** [Type]

**The Hook:**
[Why someone would want this badly enough to give their email — the promise that got them to opt in]

**The Bridge:**
[How consuming this naturally leads to wanting the paid offer]

**Quick Win Delivered:**
[The specific transformation or result they get from the lead magnet itself]

**Paid Offer:**
- Name: [Product name]
- Price: [Price point]
- Transformation: [What the paid offer delivers that the lead magnet doesn't]
```

### Example Handoff: Headline Swipe File

```markdown
## Lead Magnet Handoff for Email Sequences

**Lead Magnet:** 100 Proven Headlines That Generated Millions
**Format:** PDF swipe file

**The Hook:**
Steal headlines that already work instead of staring at a blank page. 100+ proven headlines organised by type with analysis of why each converts.

**The Bridge:**
Headlines are the first skill in copywriting. If they found the swipe file useful, they want the full copywriting methodology — not just what works, but why it works and how to create their own.

**Quick Win Delivered:**
They can immediately use these headlines for their own projects. No learning curve — just adapt and deploy. The analysis teaches pattern recognition they can apply to future headlines.

**Paid Offer:**
- Name: Complete Copywriter Course
- Price: $997
- Transformation: Go from struggling writer to confident copywriter charging $5k+ per project. The course teaches the methodology behind the headlines, plus sales pages, emails, and landing pages.
```

### How This Informs Email Sequence Content

| Email Type | What the Handoff Informs |
|------------|--------------------------|
| **Welcome email (Email 1)** | Delivery instructions based on format; reinforces the hook; sets expectations for what's coming |
| **Value emails (Emails 3-4)** | Extend the quick win; teach related concepts that build on what the lead magnet delivered |
| **Bridge email (Email 5)** | Uses the bridge directly — "You can do X now, but can you do Y?" where Y is what the paid offer enables |
| **Pitch emails (Emails 6-7)** | Price point determines urgency level; paid offer transformation drives the pitch angle |

### When to Create the Handoff

Create the handoff document when:
1. Client selects a lead magnet concept from the options provided
2. Before running email-sequences skill
3. When an existing lead magnet needs a new welcome sequence

Store the handoff in the same location as the lead magnet concept or pass it directly to the email-sequences skill.
