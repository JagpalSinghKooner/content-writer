...
tags:
  - "adhd sleep"
  - "autism sleep"
  - "neurodivergent sleep problems"
  - "adhd and autism together"
  - "sleep differences"

# SEO metadata
primary_keyword: "adhd sleep vs autism sleep"
...
og_description: "ADHD and autism cause different sleep problems. Understanding which challenges your child faces helps you find solutions that actually fit."
og_image: ""
canonical_url: ""
...
external_citations:
  - url: "https://www.nottsapc.nhs.uk/media/w4ydkpqq/sleeping-well-with-autism-and-adhd.pdf"
    author: "Nottinghamshire NHS"
    year: "2024"
    title: "Sleeping Well with Autism and ADHD"
  - url: "https://www.autism.org.uk/advice-and-guidance/topics/physical-health/sleep/parents"
    author: "National Autistic Society"
    year: "2024"
    title: "Sleep - a guide for parents of autistic children"
  - url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC5799342/"
    author: "European Child & Adolescent Psychiatry"
    year: "2018"
    title: "Sleep, chronotype, and sleep hygiene in children with ADHD and ASD"
  - url: "https://pubmed.ncbi.nlm.nih.gov/38158389/"
...
Nottinghamshire NHS notes that "the quietness associated with night-time can be difficult for an ADHD brain to manage" because "there is nothing to occupy your brain" — leading to racing thoughts that keep children awake.
...
Research published in European Child & Adolescent Psychiatry, 2018 — [Sleep, chronotype, and sleep hygiene in children with ADHD and ASD](https://pmc.ncbi.nlm.nih.gov/articles/PMC5799342/) found that children with ADHD showed a stronger evening orientation compared to controls, with later sleep onset times across the board.

### Sleep Pattern Variability

One distinctive marker of ADHD is night-to-night inconsistency. Your child might fall asleep at 9pm one night and be wide awake until midnight the next — even with the same routine. This variability itself is characteristic of ADHD sleep patterns.
...
The National Autistic Society, 2024 — [Sleep - a guide for parents of autistic children](https://www.autism.org.uk/advice-and-guidance/topics/physical-health/sleep/parents) highlights that sensory differences are a major factor in autism sleep difficulties. These can include:
...
For autistic children, the environment itself can prevent sleep — not because their brain is racing, but because their sensory system is on high alert.
...
While both ADHD and autistic children benefit from routine, the stakes feel different. For autistic children, unexpected changes to bedtime routine can cause genuine distress — not just resistance, but anxiety about things being "wrong."
...
Like ADHD, autism is associated with melatonin irregularities — but the pattern can differ. Autistic children may have irregular melatonin secretion rather than simply delayed production. The National Autistic Society notes that some autistic individuals have "atypical circadian rhythms" that don't follow typical patterns.
...
Research published in Autism Research, 2024 — [Sleep problems in children with ASD and ADHD: A comparative study](https://pubmed.ncbi.nlm.nih.gov/38158389/) found that children with ADHD actually showed more total sleep problems than children with autism alone, including more sleep breathing disorders and night sweating.
