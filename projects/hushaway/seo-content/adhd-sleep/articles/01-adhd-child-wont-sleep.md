...
# SEO metadata
primary_keyword: "adhd child won't sleep"
secondary_keywords_used:
  - "why won't my adhd child sleep"
  - "adhd brain won't turn off at night"
  - "adhd sleep problems"
keyword_density: "1.4%"
word_count: "2247"

# Open Graph
og_title: "Why Your ADHD Child Won't Sleep (And What Actually Helps)"
og_description: "Generic sleep advice fails ADHD kids because their brains work differently. Here's what actually helps."
og_image: ""
canonical_url: ""
...
external_citations:
  - url: "https://www.uhs.nhs.uk/whats-new/press-releases/southampton-researchers-launch-new-study-to-help-children-with-adhd-sleep-better"
    ...
    year: "2022"
    title: "Southampton researchers launch new study to help children with ADHD sleep better"
  ...
  - url: "https://www.frontiersin.org/journals/psychiatry/articles/10.3389/fpsyt.2025.1697900/full"
    author: "Frontiers in Psychiatry"
    year: "2025"
    title: "ADHD as a circadian rhythm disorder: evidence and implications for chronotherapy"
---

You've tried everything. The warm bath. The bedtime story. Lights out at the same time every night. You've followed every piece of sleep advice you can find.

And still, your ADHD child won't sleep.

It's 10pm. Then 11pm. You can hear them tossing and turning, getting up for water, asking questions, finding reasons to leave their room. By midnight, you're exhausted and frustrated. They're wide awake.

Here's what nobody tells you: the problem isn't that you're doing it wrong. The problem is that generic sleep advice wasn't built for ADHD brains.

## Why Generic Sleep Advice Fails ADHD Children

Every sleep guide says the same things. Consistent bedtime. Cool room. No screens before bed. Create a calming routine.

This advice works beautifully for neurotypical children. Their brains respond to these environmental cues, wind down on schedule, and drift off to sleep.
...
Your child isn't being difficult. Their brain is doing exactly what ADHD brains do.
...
ADHD brains don't have an "off switch" for thoughts. When the external stimulation stops (lights off, room quiet), the internal stimulation ramps up. Ideas. Worries. Random thoughts about dinosaurs. Questions about space. Replaying conversations from the day.

The quieter the room, the louder the brain becomes. That's why telling an ADHD child to "just relax and go to sleep" is about as useful as telling someone with a broken leg to "just walk it off."
...
We need to talk about something that breaks my heart when I hear it from parents: the guilt.

You've been told that sleep problems are a parenting issue. That if you just stuck to the routine more consistently, if you just said "no" more firmly at bedtime, your child would sleep.
...
Parents in this study described bedtime as a "fight" and talked about feeling like nothing they did made a difference. Sound familiar? You're not alone. And it's not your fault.

## The Standard Solutions (And Why They're Not Enough)

Let's be honest about what the typical advice looks like and why it falls short for ADHD families.
...
This isn't about drowning out thoughts. It's about giving the brain what it naturally seeks, in a form that leads toward sleep rather than away from it.

### Why "Just Press Play" Matters

Here's something we understand at HushAway®: you're exhausted too.

By bedtime, you've already navigated breakfast battles, school runs, homework struggles, after-school meltdowns, and dinner negotiations. You don't have the energy for a complicated bedtime intervention.
...
### The Research Behind Sound and ADHD Sleep
...
Many parents ask about melatonin, and it's worth addressing briefly.
...
The most effective approaches combine addressing the circadian delay (melatonin can help here) WITH addressing the racing brain (passive sound does this). One without the other often isn't enough.

## Your Next Step

If you've read this far, you're probably nodding at the descriptions. You know the midnight battles. You know the guilt. You know the exhaustion.

Here's something that might help tonight:

The Open Sanctuary from HushAway® is a free collection of sounds designed specifically for sensitive and neurodivergent children. No signup required. No cost. Just sounds you can try tonight.

Pick something from the night time collection. Press play. See if it helps.
...
### Why won't my ADHD child sleep even when they're tired?

ADHD children can be physically exhausted while their brain remains highly active. This is because ADHD affects the brain's ability to regulate arousal and transition between states. The body says "sleep" but the brain says "think about seventeen things at once." This is why solutions that address the brain's need for calming input work better than simply making children physically tired.
...
Some ADHD children find weighted blankets helpful because they provide proprioceptive input (pressure feedback) that can be calming. However, weighted blankets address physical restlessness, not racing thoughts. Many children need both physical calming (weighted blankets can help) AND mental calming (passive sound can help) to successfully fall asleep.
