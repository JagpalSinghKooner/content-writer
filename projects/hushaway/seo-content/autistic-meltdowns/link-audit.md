...
|-------|-------|--------|
| Broken links | 8 | FAIL |
| Incorrect URL format | 25 | FAIL |
| Stale placeholders | 0 | PASS |
| Valid placeholders | 0 | INFO |
| Guide → Supporting coverage | 6/6 | PASS |
| Supporting → Guide coverage | 6/6 | PASS |
...
1. **01-understanding-autism-meltdowns.md** (line 44, frontmatter):
...
3. **01-understanding-autism-meltdowns.md** (line 48, frontmatter):
   - Current: `/autistic-meltdowns/06-preventing-meltdowns`
   - Should be: `/preventing-autism-meltdowns-warning-signs`
   - Fix: Replace URL with frontmatter slug of target article

4. **01-understanding-autism-meltdowns.md** (line 50, frontmatter):
...
5. **01-understanding-autism-meltdowns.md** (line 159, content):
   - Current: `/autistic-meltdowns/sounds-to-play-autism-meltdown`
   - Should be: `/sounds-to-play-autism-meltdown`
   - Fix: Remove `/autistic-meltdowns/` directory prefix

6. **01-understanding-autism-meltdowns.md** (line 175, content):
...
11. **02-what-to-play-during-meltdown.md** (line 90, content):
    - Current: `/autistic-meltdowns/01-understanding-autism-meltdowns`
    - Should be: `/understanding-autism-meltdowns`
    - Fix: Remove directory prefix and number prefix
...
14. **03-after-school-autism-meltdown-why.md** (line 44, frontmatter):
    - Current: `/autistic-meltdowns/01-understanding-autism-meltdowns`
    - Should be: `/understanding-autism-meltdowns`
    - Fix: Remove directory prefix and number prefix

15. **03-after-school-autism-meltdown-why.md** (line 46, frontmatter):
    - Current: `/autistic-meltdowns/02-what-to-play-during-meltdown`
    - Should be: `/sounds-to-play-autism-meltdown`
    - Fix: Replace URL with correct slug
...
18. **03-after-school-autism-meltdown-why.md** (line 117, content):
    - Current: `/autistic-meltdowns/01-understanding-autism-meltdowns`
    - Should be: `/understanding-autism-meltdowns`
    - Fix: Remove directory prefix and number prefix

19. **03-after-school-autism-meltdown-why.md** (line 205, content):
    - Current: `/autistic-meltdowns/02-what-to-play-during-meltdown`
    - Should be: `/sounds-to-play-autism-meltdown`
    - Fix: Replace URL with correct slug
...
35. **06-preventing-autism-meltdowns-warning-signs.md** (line 43, frontmatter):
    - Current: `/autistic-meltdowns/articles/01-understanding-autism-meltdowns`
    - Should be: `/understanding-autism-meltdowns`
    - Fix: Remove `/autistic-meltdowns/articles/` directory structure

36. **06-preventing-autism-meltdowns-warning-signs.md** (line 45, frontmatter):
    - Current: `/autistic-meltdowns/articles/02-what-to-play-during-meltdown`
    - Should be: `/sounds-to-play-autism-meltdown`
...
39. **06-preventing-autism-meltdowns-warning-signs.md** (line 88, content):
    - Current: `/autistic-meltdowns/articles/01-understanding-autism-meltdowns`
    - Should be: `/understanding-autism-meltdowns`
    - Fix: Remove `/autistic-meltdowns/articles/` directory structure

40. **06-preventing-autism-meltdowns-warning-signs.md** (line 247, content):
    - Current: `/autistic-meltdowns/articles/02-what-to-play-during-meltdown`
    - Should be: `/sounds-to-play-autism-meltdown`
    - Fix: Remove directory structure and fix slug
...
43. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 48, frontmatter):
    - Current: `/autistic-meltdowns/articles/02-what-to-play-during-meltdown`
    - Should be: `/sounds-to-play-autism-meltdown`
    - Fix: Remove directory structure and fix slug

44. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 50, frontmatter):
    - Current: `/autistic-meltdowns/articles/03-after-school-autism-meltdown-why`
    - Should be: `/after-school-autism-meltdown-why`
    - Fix: Remove `/autistic-meltdowns/articles/` directory structure

45. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 52, frontmatter):
    - (continues with similar pattern for remaining frontmatter links)

46. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 133, content):
    - Current: `/autistic-meltdowns/articles/01-understanding-autism-meltdowns`
    - Should be: `/understanding-autism-meltdowns`
    - Fix: Remove `/autistic-meltdowns/articles/` directory structure

47. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 187, content):
    - Current: `/autistic-meltdowns/articles/06-preventing-autism-meltdowns-warning-signs`
    - Should be: `/preventing-autism-meltdowns-warning-signs`
    - Fix: Remove `/autistic-meltdowns/articles/` directory structure

48. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 267, content):
    - Current: `/autistic-meltdowns/articles/02-what-to-play-during-meltdown`
    - Should be: `/sounds-to-play-autism-meltdown`
    - Fix: Remove directory structure and fix slug
...
These links point to slugs that don't exist in any pillar OR use incorrect slug names.
...
3. **02-what-to-play-during-meltdown.md** (line 49, frontmatter):
   ...
   - Intended slug: `preventing-autism-meltdowns-warning-signs`
   - Fix: Update to `/preventing-autism-meltdowns-warning-signs`

4. **03-after-school-autism-meltdown-why.md** (line 46, frontmatter):
   - URL: `/autistic-meltdowns/02-what-to-play-during-meltdown`
   - Intended slug: `sounds-to-play-autism-meltdown`
   - Fix: Update to `/sounds-to-play-autism-meltdown`
...
## Additional Format Violation

1. **06-preventing-autism-meltdowns-warning-signs.md** (line 45, frontmatter):
   - Uses: `/autistic-meltdowns/articles/02-what-to-play-during-meltdown`
   - Should be: `/sounds-to-play-autism-meltdown`
   - Multiple issues: directory structure AND wrong slug

2. **07-complete-guide-autism-meltdowns-uk-parents.md** (line 48, frontmatter):
   - Uses: `/autistic-meltdowns/articles/02-what-to-play-during-meltdown`
   - Should be: `/sounds-to-play-autism-meltdown`
   - Multiple issues: directory structure AND wrong slug
...
|---------------|-------------|---------------|
| 02-what-to-play-during-meltdown.md | the-open-sanctuary | External/Unknown |

**Note:** `/the-open-sanctuary` appears to be an external landing page or product page, not another pillar article.

### Inbound (from other pillars to this one)

No inbound cross-pillar links detected.
...
**Primary Problem:** Inconsistent link format across the pillar. Two different incorrect patterns used:

1. **Pattern A:** `/autistic-meltdowns/{slug}` (removes `articles/` but keeps pillar prefix)
2. **Pattern B:** `/autistic-meltdowns/articles/{filename}` (uses full directory structure)

Both patterns violate Rule 5a. Correct format is `/{slug}` only.
...
1. Search and replace in all articles:
   - `/autistic-meltdowns/articles/` → `/`
   - `/autistic-meltdowns/` → `/`
...
3. Add missing link in 02-what-to-play-during-meltdown.md to pillar guide

**Total violations:** 51 format violations + 12 broken slug references + 1 missing bidirectional link = 64 issues
